...
| Size budgets                                   | green — audited ceilings core ESM 13.1 KB, IIFE 13.45, voice 4.45, react 0.47, vue 0.6 (gz); the raise over pre-audit ceilings is the measured cost of the certification fixes, documented in the production-audit changeset |
