...
| `onSubmit`      | `(payload: ReviewerStore) => void \| Promise<void>`             | fires from the panel's "Send to builder" button (rendered only when `onSubmit` is configured); host owns upload/delivery                                                                                                                                                                                                                                                                                                                                           |
