...
// bare `pinflowjs` specifier so the consumer's bundler resolves ONE shared core
...
// esm: `from"pinflowjs"` / `import"pinflowjs"`; cjs: `require("pinflowjs")`.
const BARE_SPECIFIER = /from\s*["']pinflowjs["']|require\(["']pinflowjs["']\)/;
