...
Budgets re-ratcheted to the audited actuals: core ESM 12.8 KB, IIFE 13.1 KB, voice 4.4 KB, react wrapper 0.45 KB (gz) — the measured cost of the correctness work above.
