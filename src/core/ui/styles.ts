...
export const STYLES =
  ...
  '.control[data-active="true"]{background:#2563eb}' +
  '.panel{position:fixed;pointer-events:auto;min-width:260px;max-width:320px;background:#fff;color:#0f172a;border-radius:12px;padding:16px;box-shadow:0 16px 48px rgba(15,23,42,.18),0 2px 6px rgba(15,23,42,.08);font-size:13px;line-height:1.45}' +
  '.panel h3{margin:0 0 8px;font-size:13px;font-weight:600}' +
  '.panel p{margin:0 0 12px;opacity:.75}' +
  ...
  '.pin{position:fixed;pointer-events:auto;width:24px;height:24px;border-radius:999px;background:#2563eb;color:#fff;display:grid;place-items:center;font-size:11px;font-weight:600;box-shadow:0 4px 10px rgba(37,99,235,.35),0 0 0 2px #fff;cursor:pointer;transform:translate(-50%,-50%) scale(0);animation:pop .18s ease forwards;transition:transform .12s ease}' +
  ...
  '.input{position:fixed;pointer-events:auto;min-width:240px;max-width:320px;background:#fff;color:#0f172a;border-radius:10px;padding:10px;box-shadow:0 12px 32px rgba(15,23,42,.18),0 2px 6px rgba(15,23,42,.08)}' +
  ...
  '.input .actions{display:flex;justify-content:space-between;align-items:center;margin-top:6px;font-size:12px;opacity:.7}' +
